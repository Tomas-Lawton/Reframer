const sketch = function(p) {
    ...
    p.mouseReleased = function() {
        if (p.isInBounds()) {
            ...
            if (currentRawLineSimplified.length > 1) {
                ...
                const stroke = model.lineToStroke(currentRawLineSimplified, [
                    startX,
                    startY,
                ]);
    ...
    function initDOMElements() {
        let inputTemperature = document.getElementById("textTemperature");
        // Setup the DOM bits.
        textTemperature.textContent = inputTemperature.value;
        // Listeners
        ...
        //     selectModels.selectedIndex = Math.floor(
